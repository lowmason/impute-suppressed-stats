...
cell. A disclosed private `113` parent does publish an upper bound on 756 of those 1,227 cells —
measured, but not yet a constraint row; `specs/stage5-parent-margin.md` owns wiring it in.
