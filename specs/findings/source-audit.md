...
Everything from here to the end of the document is the recorded evidence itself: for each source, its `access`, `coverage_span` and `findings` objects rendered whole from `data/raw/audit/<source>/summary.json`, unabridged and unedited. Nothing in this section is summarised, ranked or interpreted by this assembler -- where a recorded value contains a reading rather than a measurement, it is the source script that says so, inside the value.
...
_Extracts: 5; summary `generated_utc` 2026-09-04T23:14:01+00:00._
...
_Extracts: 5; summary `generated_utc` 2026-09-04T23:13:46+00:00._
